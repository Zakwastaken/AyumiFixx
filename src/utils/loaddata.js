...
const characters = JSON.parse(fs.readFileSync(path.join(__dirname, './character.json')));
...
const probabilities = JSON.parse(fs.readFileSync(path.join(__dirname, './prob.json')));
